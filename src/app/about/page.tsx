              ...
              from-transparent via-blue-500/50 to-transparent"
                ...
                <div className="relative p-8 md:p-12">
                  ...
                  <div className="text-center mb-12">
                    ...
                    <h2 className="text-3xl font-semibold text-white mb-4">CodeNest Studio Features</h2>
                    <p className="text-gray-400 text-lg mb-8">Unlock the full potential of your code with our advanced platform, free for everyone.</p>
                  </div>
                  ...
                  <div className="flex justify-center">
                    <SignedIn>
                      ...
                      bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg hover:from-blue-600 hover:to-blue-700 
                      transition-all duration-300 font-semibold text-lg shadow-lg hover:shadow-blue-500/20"
                      >
                        Start Coding Now
                      </Link>
                    </SignedIn>
